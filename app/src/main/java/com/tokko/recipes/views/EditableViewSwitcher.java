...
public abstract class EditableViewSwitcher<W1 extends View, W2 extends View, D> extends LinearLayout implements Editable<D> {
    protected W1 label;
    protected W2 edit;

    public EditableViewSwitcher(Context context, AttributeSet attrs, W1 w1, W2 w2) {
        super(context, attrs);
        label = w1;
        edit = w2;
